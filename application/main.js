window.onload = function() {
    ...
    function aimGun(mouseX, mouseY) {
        ...
        gun.angle = utils.clamp(gun.angle, -Math.PI / 2, -0.3);
    }
    ...
    function draw() {
        ...
        context.beginPath();
        context.arc(cannonball.x, cannonball.y,
                    cannonball.radius, 0, Math.PI*2, false);
        context.fill();

        context.beginPath();
        context.fillStyle = "red";
        context.arc(target.x, target.y,
                    target.radius, 0, Math.PI*2, false);
        context.fill();
    }
}
